...
const scriptsInEvents = {
	...
	async Game_Event254_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async Game_Event262_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async Game_Event317_Act2(runtime, localVars)
	{
		showRewardedAd();
	},

	async Game_Event331_Act7(runtime, localVars)
	{
