...
const scriptsInEvents = {
	...
	async EventMenu_Event1_Act4(runtime, localVars)
	{
	...
	async EventMain_Event41_Act14(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async EventMain_Event55_Act1(runtime, localVars)
	{
		showRewardedAd();
	},

	async EventMain_Event69_Act8(runtime, localVars)
	{
