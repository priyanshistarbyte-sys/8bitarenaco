...
const scriptsInEvents = {
	...
	async MenuEventSheet_Event7_Act17(runtime, localVars)
	{
	...
	async GameEventSheet_Event276_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async GameEventSheet_Event326_Act2(runtime, localVars)
	{
		showRewardedAd();
	},

	async GameEventSheet_Event341_Act8(runtime, localVars)
	{
		...
		googletag.cmd.push(function () {
		  try {
		    ...
		    rewardedSlot = googletag
		      .defineOutOfPageSlot('/23334516659/h5_3', googletag.enums.OutOfPageFormat.REWARDED)
		      .addService(googletag.pubads());
