...
function defineGamingInterstitialSlot() {
  gamingInterstitialSlot = googletag.defineOutOfPageSlot(
    "/23334516659/h5_4", // 🔁 Replace with your ad unit path
...
gptScript.onload = function () {
  googletag.cmd.push(() => {
    ...
    googletag.defineSlot("/23334516659/h5_4", [100, 100], "static-ad-1")
...
const scriptsInEvents = {
	...
	async L10_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L11_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L12_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L13_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L14_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L15_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L16_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L17_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L18_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L19_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L1_sht_Event1_Act2(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L20_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L21_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L2_sht_Event1_Act2(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L3_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L4_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L5_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L6_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L7_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L8_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async L9_sht_Event1_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	}
};
