...
const scriptsInEvents = {
	...
	async Einitialscreen_Event2_Act2(runtime, localVars)
	{
	...
	async Esgame_Event180_Act1(runtime, localVars)
	{
		window.showInterstitialAd();
	},

	async Esgame_Event227_Act2(runtime, localVars)
	{
		showRewardedAd();
	},

	async Esgame_Event247_Act8(runtime, localVars)
	{
